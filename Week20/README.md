...
- **Worker Thread Pattern**: "작업 일꾼 패턴". I/O와 로직 처리를 담당하는 쓰레드를 분리하는 설계.
- **Task Queue**: "일감 바구니". 처리해야 할 작업들을 쌓아두는 큐.
- **Thread Separation**: "역할 분담". 네트워크 I/O와 게임 로직을 서로 다른 쓰레드가 처리.
